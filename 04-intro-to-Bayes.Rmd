...
3) Выборки из апостериорного распределения (Posterior simulation):
    ...
    * используйте полученныую выборку для статистического вывода.
    
Например, допустим мы получили апостериорное бета распределение с параметрами 20 и 70. Какова вероятность наблюдать значения больше 0.3?
