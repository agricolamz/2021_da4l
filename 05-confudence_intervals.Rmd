...
vowels %>% 
  ...
  annotate(geom = "text", y = -0.002, x = qnorm(0.5, mean_post, sd_post), label = "95% credible interval")+
  annotate(geom = "text", y = 0.001, x = qnorm(0.5, mean_post, sd_post), label = "80% credible interval")
```
