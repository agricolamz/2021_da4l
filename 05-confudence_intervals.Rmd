...
diff <- cred_int_h_95-(cred_int_h_95-cred_int_l_95)/2
...
vowels %>% 
  ...
  annotate(geom = "text", y = -0.002, x = diff, label = "95% credible interval")+
  annotate(geom = "text", y = 0.001, x = diff, label = "80% credible interval")
```
